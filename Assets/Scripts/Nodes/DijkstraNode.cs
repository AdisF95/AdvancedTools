...
public class DijkstraNode : BaseNode
{
    public List<BaseNode> connections = new List<BaseNode>();

    private void OnTriggerEnter(Collider other)
    {
        connections.Add(other.gameObject.GetComponent<DijkstraNode>());
        DrawLines(connections);
    }

    private void OnTriggerExit(Collider other)
    {
        connections.Remove(other.gameObject.GetComponent<DijkstraNode>());
    }
